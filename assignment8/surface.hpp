...
public:
    ...
    virtual void OutputBezier(FILE *file){ cout << "sr be" << endl; curve->OutputBezier(file); }
    virtual void OutputBSpline(FILE *file){ cout << "sr bs" << endl; curve->OutputBSpline(file); }
